  ...
  return (
    <div ref={ref} className="relative w-full">
      <button
        ...
        className="flex h-11 w-full items-center justify-between rounded-lg border border-border bg-white px-3 text-sm text-text transition-colors duration-200 hover:border-text-secondary/40"
      >
      ...
      {open && (
        <div className="absolute left-0 top-11 z-30 w-full rounded-lg border border-border bg-white p-2 shadow-lg">
          ...
          <input
            ...
            placeholder="搜索职位名称…"
            className="mb-1.5 h-9 w-full rounded-md border border-border px-2 text-xs transition-colors duration-200"
          />
